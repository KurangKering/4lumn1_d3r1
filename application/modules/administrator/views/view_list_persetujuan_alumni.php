    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-content">
          <table id="table-persetujuan" class="table table-striped">
            <thead>
              <tr>
                <th>No.</th>
                <th>NPM</th>
 ...
 <div class="modal-dialog modal-lg">
   <div class="modal-content animated bounceInRight">
     <div class="modal-header">
       ...
       <h4 class="modal-title">Persetujuan Akun Alumni</h4>
    ...
    <div class="modal-footer">
      <button type="button" id="btn-tolak" class="btn btn-danger btn-pilihan"  data-pilihan="tolak">Tolak</button>
      <button type="button" id="btn-setuju" class="btn btn-primary btn-pilihan"  data-pilihan="setuju">Setuju</button>
    </div>
  </div>
</div>
</div>
...
$(document).ready(function() {
  ...
  var table_persetujuan = $('#table-persetujuan').DataTable({ 
   "bAutoWidth": false ,
   "processing": true, 
   "serverSide": true, 
   "order": [], 
   ...
   "ajax": {
    "url": '<?php echo site_url('administrator/json_get_list_persetujuan_alumni'); ?>',
    "type": "POST"
  },
  "columns": [
  {"data" : "nomor" ,
  ...
  $('.btn-pilihan').click(function(){
    pilihan = $(this).data('pilihan');
    npm = $('#npm').text();
    $.ajax({
      url: '<?php echo site_url() . 'administrator/set_aktif_alumni' ?>',
      type: 'POST',
