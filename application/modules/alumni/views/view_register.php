        ...
        <form method="post" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="ibox-content">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input required type="text" name="npm" data-mask="999999999" class="form-control"> <span class="help-block m-b-none gray-bg">Digunakan sebagai username ketika login</span>
                </div>
            </div>
