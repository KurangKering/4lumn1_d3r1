...
$admin_fakultas = $this->db->select('nama')->where('id_role', $id_role)->get('role')->row_array()['nama'];
 ?>
<!DOCTYPE html>
<html>
...
<body class="">
  ...
  <div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <ul class="nav metismenu" id="side-menu">
          <li class="nav-header">
            ...
            <a data-toggle="dropdown" class="dropdown-toggle" href="<?php echo site_url() . 'assets/template/inspinia_271/' ?>#">
              <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><?php echo isset($admin_fakultas) ? $admin_fakultas : '' ?></strong>
            </span>  </span> </a>
      ...
      <li>
        <a href="<?php echo site_url() . 'admin/daftar_alumni' ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Alumni</span></a>
      </li>
