  ...
  <div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
      <div class="sidebar-collapse">
        ...
        <li>
         <a href="<?php echo site_url() . 'assets/template/inspinia_271/' ?>index.html"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboard</span></a>
       </li>
      ...
      <li>
        ...
        <ul class="nav nav-second-level collapse">
          ...
          <li><a href="<?php echo site_url() . 'informasi/informasi_saya' ?>">Informasi Saya</a></li>
        </ul>
      </li>
      <li>
